    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images_url', models.URLField(blank=True, max_length=10000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Manga', 'Manga'), ('Manhua', 'Manhua'), ('Manhwa', 'Manhwa'), ('Comic', 'Comic'), ('Novel', 'Novel')], default='Manhwa', max_length=1000)),
