    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Manhua', 'Manhua'), ('Manhwa', 'Manhwa'), ('Manga', 'Manga')], default='Manhwa', max_length=10)),
                ...
                ('updated', models.CharField(blank=True, max_length=100)),
                ('created', models.CharField(blank=True, max_length=100)),
